...
const EditProfile: NextPage = () => {
  return (
    <div className="py-10 px-4 space-y-4">
      ...
      <button className="mt-5 w-full bg-purple-500 hover:bg-purple-400 text-white py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:outline-none ">
        Update profile
      </button>
    </div>
  );
