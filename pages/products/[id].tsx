        ...
        <div className="mb-8">
          ...
          <div className="mt-5">
            ...
            <div className="flex items-center justify-between space-x-2">
              <button className="flex-1 bg-purple-500 text-white py-3 rounded-md font-semibold hover:bg-purple-400 focus:outline-none ">
                Talk to seller
              </button>
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            {[1, 2, 3, 4, 5, 6].map((_, i) => (
              <div key={i} className="cursor-pointer">
                ...
                <span className="text-sm text-gray-900 font-semibold">$6</span>
              </div>
            ))}
          </div>
        </div>
